...
<div class="page-inner">
    ...
    <div class="page-header-modern">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h3 class="page-title-modern">All Projects
</h1>
            </div>
            <div>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3 mb-4">
                    <div class="modern-card card-animation" style="animation-delay: {{ $index * 0.1 }}s;">
                        <div class="p-4">
                            ...
                            <p class="course-meta">Course Projects</p>

                            <!-- Action Button -->
                            <a href="{{ route('project.submit', ['id' => $detail->course_id, 'co' => $detail->cohort_id]) }}" 
                               class="modern-btn">
                                View Project
    ...
    @else
        ...
        <div class="empty-state">
            ...
            <h3 class="empty-title">No Project Yet</h3>
            <p class="empty-text">
                You don't have any course project at the moment. 
