...
<div class="page-inner">
    ...
    <div class="page-header-modern">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="page-subtitle">Stay updated with your course notifications</p>
            </div>
            <div>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3 mb-4">
                    <div class="modern-card card-animation" style="animation-delay: {{ $index * 0.1 }}s;">
                        <div class="p-4">
                            ...
                            <p class="course-meta">Course notifications</p>

                            <!-- Action Button -->
                            <a href="{{ route('notification.all', ['id' => $detail->course_id, 'co' => $detail->cohort_id]) }}" 
                               class="modern-btn">
                                View Notifications
    ...
    @else
        ...
        <div class="empty-state">
            ...
            <p class="empty-text">
                You don't have any course notifications at the moment. 
