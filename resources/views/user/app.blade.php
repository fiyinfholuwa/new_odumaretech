...
<li class="pc-item pc-hasmenu">
    ...
    <ul class="pc-submenu">
        <li class="pc-item"><a class="pc-link" href="{{ route('course.active') }}">My Active Course</a></li>
        <li class="pc-item"><a class="pc-link" href="{{ route('course.complete') }}">My Completed Courses</a></li>
    </ul>
</li>
...
<li class="pc-item pc-hasmenu">
    <a href="#!" class="pc-link">
        ...
        <span class="pc-mtext">Chat with Instructor</span>
        <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
    </a>
    <ul class="pc-submenu">
        <li class="pc-item"><a class="pc-link" href="{{ route('chat.user.view') }}">Compose Message</a></li>
        <li class="pc-item"><a class="pc-link" href="{{ route('chat.user.all') }}">All Chats</a></li>
    </ul>
</li>
...
<li class="pc-item pc-hasmenu">
    <a href="#!" class="pc-link">
        <span class="pc-micon"><i class="fas fa-sticky-note"></i></span>
        <span class="pc-mtext">Manage Final Project</span>
        <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
    </a>
    <ul class="pc-submenu">
        <li class="pc-item"><a class="pc-link" href="{{ route('project.user.view') }}">My Projects</a></li>
        <li class="pc-item"><a class="pc-link" href="{{ route('project.submitted.user') }}">View Submitted Projects</a></li>
    </ul>
</li>
...
<li class="pc-item">
    <a href="{{ route('user.github') }}" class="pc-link">
        <span class="pc-micon"><i class="fa fa-globe"></i></span>
        <span class="pc-mtext">Github</span>
    </a>
</li>
...
s1.async=true;
s1.src='https://embed.tawk.to/68d97c914bdd921950d1e326/1jb61lef5';
s1.charset='UTF-8';
