        ...
        @else
            ...
            <div class="col-12">
                <div class="empty-state">
                    ...
                    <h4 class="empty-state-title">No Completed Courses Available</h4>
                    <p class="empty-state-text">"Looks like you haven’t completed any courses yet. Your completed courses will show up here once you have completed any of them.</p>
                    <div class="empty-state-action">
                        <button class="btn bgc-secondary" style="padding: 20px;" onclick="location.reload()">
