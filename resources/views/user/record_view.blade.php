                    ...
                    <div style="background:#E9ECFF;" class="resource-card h-100">
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-actions">
                                <a style="background:#0E2293;" href="{{route('records.user.all',  ['id' => $detail->course_id, 'co' => $detail->cohort_id])}}" 
        ...
        @else
            ...
            <div class="col-12">
                <div class="empty-state">
                    ...
                    <h4 class="empty-state-title">No Records Available</h4>
                    <p class="empty-state-text">Your Record resources will appear here once they're uploaded by your instructors.</p>
