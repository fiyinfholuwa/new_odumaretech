...
<head>
    <title>OdumareTech - Instructor Dashboard</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
...
<nav class="pc-sidebar">
    <div class="navbar-wrapper">
        <div class="m-header">
            <a href="{{route('instructor.dashboard')}}" class="b-brand text-primary">
...
<li class="pc-item pc-hasmenu">
    ...
    <ul class="pc-submenu">
        <li class="pc-item"><a class="pc-link" href="{{ route('assignment.view') }}">Add Assignment</a></li>
        <li class="pc-item"><a class="pc-link" href="{{ route('assignment.all') }}">All Assignments</a></li>
    </ul>
</li>

<li class="pc-item pc-hasmenu">
    <a href="#!" class="pc-link">
        <span class="pc-micon"><i class="fas fa-calendar"></i></span>
        <span class="pc-mtext">Manage Live Session</span>
        <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
    </a>
    <ul class="pc-submenu">
...
<li class="pc-item pc-hasmenu">
    <a href="#!" class="pc-link">
        <span class="pc-micon"><i class="fa fa-bookmark"></i></span>
        <span class="pc-mtext">Manage Course Project</span>
        <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
    </a>
    <ul class="pc-submenu">
        <li class="pc-item"><a class="pc-link" href="{{ route('project.final.view') }}">Add Final Project</a></li>
        <li class="pc-item"><a class="pc-link" href="{{ route('project.final.all') }}">Manage Final Project</a></li>
        <li class="pc-item"><a class="pc-link" href="{{ route('project.submitted.review') }}">Review Submitted Projects</a></li>
    </ul>
</li>

<li class="pc-item">
    <a href="{{ route('assignment.submitted.review') }}" class="pc-link">
        <span class="pc-micon"><i class="fas fa-star"></i></span>
        <span class="pc-mtext">Review Assignments</span>
    </a>
</li>

<li class="pc-item">
    <a href="{{ route('instructor.github') }}" class="pc-link">
        <span class="pc-micon"><i class="fas fa-globe"></i></span>
        <span class="pc-mtext">Github Link</span>
    </a>
</li>

<li class="pc-item">
    <a href="{{ route('instructor.meeting') }}" class="pc-link">
        <span class="pc-micon"><i class="fas fa-link"></i></span>
        <span class="pc-mtext">Meeting Link</span>
    </a>
</li>

<li class="pc-item">
    <a href="{{ route('instructor.record') }}" class="pc-link">
        <span class="pc-micon"><i class="fas fa-microphone"></i></span>
        <span class="pc-mtext">Recorded Sessions Link</span>
    </a>
</li>

<li class="pc-item">
    <a href="{{ route('student.chat') }}" class="pc-link">
        <span class="pc-micon"><i class="fas fa-comments"></i></span>
        <span class="pc-mtext">Messages from Student</span>
    </a>
</li>

<li class="pc-item">
    <a href="{{ route('instructor.password.view') }}" class="pc-link">
        <span class="pc-micon"><i class="fas fa-lock"></i></span>
