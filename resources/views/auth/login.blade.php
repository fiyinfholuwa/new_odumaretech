...
<div class="forget">
                        ...
                        <!-- Submit -->
                        <button type="submit" style="background-color: #0E2293;" class="btn btn-primary btn-login">Login</button>
                    </form>

                    <div class="signup-link">
                        <p class="text-muted">Don't have an account? <a href="{{route('register')}}" class="text-decoration-none fw-semibold">Sign Up</a></p>
                    </div>
