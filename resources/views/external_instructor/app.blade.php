...
{{--                <img style="height: 60px" src="{{asset('backend/logo.svg')}}" class="img-fluid" alt="logo">--}}
        ...
        <div class="navbar-content">
            ...
            <ul class="pc-navbar">
                ...
                <li class="pc-item">
                    <a href="{{route('external.instructor.dashboard')}}" class="pc-link">
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        <li class="pc-item"><a class="pc-link" href="{{route('in.course.view')}}">Add Course</a></li>
                        <li class="pc-item"><a class="pc-link" href="{{route('in.course.all')}}">All Course</a></li>
                    </ul>
                </li>

                <li class="pc-item">
    <a href="{{route('in.revenue')}}" class="pc-link">
