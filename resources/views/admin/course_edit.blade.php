                                ...
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" name="corporate_display" id="corporate_display" value="yes"
                                            {{ old('corporate_display', $course->corporate_display) == 'yes' ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" name="normal_display" id="normal_display" value="yes"
                                            {{ old('normal_display', $course->normal_display) == 'yes' ? 'checked' : '' }}>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="certificate" id="certificate"
                                           placeholder="Certificate Title" value="{{ old('certificate', $course->certification ?? '') }}"/>
                                    @error('certificate')
                                    <small style="color:red; font-weight:500">{{ $message }}</small>
                                    @enderror
                                </div>
                                        ...
                                        @if(count($cohorts) > 0)
                                            @foreach($cohorts as $cohort)
                                                <option value="{{$cohort->id}}"
                                                    {{ old('cohort', $course->cohort) == $cohort->id ? 'selected' : '' }}>
                                                    {{$cohort->name}}
                                                </option>
                                            @endforeach
                                        @else
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="date" name="start_date" id="start_date" required
                                           placeholder="Course Start Date" value="{{ old('start_date', $course->start_date) }}"/>
                                    @error('start_date')
                                    <small style="color:red; font-weight:500">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="lecture" id="lecture" required
                                           placeholder="Course Lecture Time" value="{{ old('lecture', $course->lecture) }}"/>
                                    @error('lecture')
                                    <small style="color:red; font-weight:500">{{ $message }}</small>
                                    @enderror
                                </div>
